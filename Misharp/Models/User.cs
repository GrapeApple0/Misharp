...
namespace Misharp.Model {
	public class User {
		...
		public class UserAvatarDecorationsPropertyType {
			public string Id { get; set; }
			...
			public override string ToString()
			{
				...
				sb.Append("class UserAvatarDecorationsPropertyType: {\n");
		...
		public List<UserAvatarDecorationsPropertyType> AvatarDecorations { get; set; }
		...
		public class UserInstanceObject {
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserInstanceObject: {\n");
		...
		public class UserBadgeRolesPropertyType {
			public string Name { get; set; }
			public string? IconUrl { get; set; }
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserBadgeRolesPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
				sb.Append($"  iconUrl: {this.IconUrl}\n");
		...
		public List<UserBadgeRolesPropertyType> BadgeRoles { get; set; }
		public string? Url { get; set; }
		...
		public class UserFieldsPropertyType {
			public string Name { get; set; }
			public string Value { get; set; }
			public override string ToString()
			{
				var sb = new StringBuilder();
				sb.Append("class UserFieldsPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserFieldsPropertyType> Fields { get; set; }
		...
		public class UserNotificationRecieveConfigObject {
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserNotificationRecieveConfigObject: {\n");
		...
		public class UserAchievementsPropertyType {
			public string Name { get; set; }
			public decimal UnlockedAt { get; set; }
			public override string ToString()
			{
				var sb = new StringBuilder();
				sb.Append("class UserAchievementsPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserAchievementsPropertyType> Achievements { get; set; }
		public decimal LoggedInDays { get; set; }
		public RolePolicies Policies { get; set; }
		public string? Email { get; set; }
		public bool? EmailVerified { get; set; }
		public class UserSecurityKeysListPropertyType {
			public string Id { get; set; }
			public string Name { get; set; }
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserSecurityKeysListPropertyType: {\n");
				sb.Append($"  id: {this.Id}\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserSecurityKeysListPropertyType> SecurityKeysList { get; set; }
		public override string ToString()
		{
			var sb = new StringBuilder();
