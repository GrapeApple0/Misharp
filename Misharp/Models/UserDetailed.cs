...
namespace Misharp.Model {
	public class UserDetailed {
		...
		public class UserDetailedAvatarDecorationsPropertyType {
			public string Id { get; set; }
			...
			public override string ToString()
			{
				...
				sb.Append("class UserDetailedAvatarDecorationsPropertyType: {\n");
		...
		public List<UserDetailedAvatarDecorationsPropertyType> AvatarDecorations { get; set; }
		public bool IsBot { get; set; }
		public bool IsCat { get; set; }
		public class UserDetailedInstanceObject {
			public string? Name { get; set; }
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedInstanceObject: {\n");
		...
		public UserDetailedInstanceObject Instance { get; set; }
		public Dictionary<string, string> Emojis { get; set; }
		public string OnlineStatus { get; set; }
		public class UserDetailedBadgeRolesPropertyType {
			public string Name { get; set; }
			public string? IconUrl { get; set; }
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedBadgeRolesPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
				sb.Append($"  iconUrl: {this.IconUrl}\n");
		...
		public List<UserDetailedBadgeRolesPropertyType> BadgeRoles { get; set; }
		public string? Url { get; set; }
		...
		public class UserDetailedFieldsPropertyType {
			public string Name { get; set; }
			public string Value { get; set; }
			public override string ToString()
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedFieldsPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserDetailedFieldsPropertyType> Fields { get; set; }
		...
		public class UserDetailedNotificationRecieveConfigObject {
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedNotificationRecieveConfigObject: {\n");
		...
		public UserDetailedNotificationRecieveConfigObject NotificationRecieveConfig { get; set; }
		public List<string> EmailNotificationTypes { get; set; }
		public class UserDetailedAchievementsPropertyType {
			public string Name { get; set; }
			public decimal UnlockedAt { get; set; }
			public override string ToString()
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedAchievementsPropertyType: {\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserDetailedAchievementsPropertyType> Achievements { get; set; }
		public decimal LoggedInDays { get; set; }
		public RolePolicies Policies { get; set; }
		public string? Email { get; set; }
		public bool? EmailVerified { get; set; }
		public class UserDetailedSecurityKeysListPropertyType {
			public string Id { get; set; }
			public string Name { get; set; }
			...
			{
				var sb = new StringBuilder();
				sb.Append("class UserDetailedSecurityKeysListPropertyType: {\n");
				sb.Append($"  id: {this.Id}\n");
				sb.Append($"  name: {this.Name}\n");
		...
		public List<UserDetailedSecurityKeysListPropertyType> SecurityKeysList { get; set; }
		public override string ToString()
		{
			var sb = new StringBuilder();
