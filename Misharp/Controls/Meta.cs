	...
	public class MetaApi {
		...
		public class AdsPropertyType {
			...
			public override string ToString()
			{
				...
				sb.Append("class AdsPropertyType: {\n");
			...
			public List<AdsPropertyType> Ads { get; set; }
		...
		public class FeaturesObject {
			...
			{
				var sb = new StringBuilder();
				sb.Append("class FeaturesObject: {\n");
			...
			public FeaturesObject Features { get; set; }
		...
		public async Task<Response<MetaResponse>> Meta(bool detail = true)
		{
			...
			var result = await _app.Request<Model.EmptyResponse>("meta", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
	}
}