...
namespace Misharp.Controls {
	public class UsersApi {
		...
		public async Task<Response<List<Model.UserDetailed>>> Users(UsersSortEnum sort,int limit = 10,int offset = 0,UsersStateEnum state = UsersStateEnum.All,UsersOriginEnum origin = UsersOriginEnum.Local,string? hostname = null)
		{
			...
			var result = await _app.Request<List<Model.UserDetailed>>("users", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<List<Model.Clip>>> Clips(string userId,int limit = 10,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.Clip>>("users/clips", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Following>>> Followers(string userId,string username,string? sinceId = null,string? untilId = null,int limit = 10,string? host = null)
		{
			...
			var result = await _app.Request<List<Model.Following>>("users/followers", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Following>>> Following(string userId,string username,string? sinceId = null,string? untilId = null,int limit = 10,string? host = null,string? birthday = null)
		{
			...
			var result = await _app.Request<List<Model.Following>>("users/following", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<List<GetFrequentlyRepliedUsersItemResponseObject>>> GetFrequentlyRepliedUsers(string userId,int limit = 10)
		{
			...
			var result = await _app.Request<List<GetFrequentlyRepliedUsersItemResponseObject>>("users/get-frequently-replied-users", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Note>>> FeaturedNotes(string userId,int limit = 10,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.Note>>("users/featured-notes", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Note>>> Notes(string userId,bool withReplies = false,bool withRenotes = true,bool withChannelNotes = false,int limit = 10,string? sinceId = null,string? untilId = null,int? sinceDate = null,int? untilDate = null,bool allowPartial = false,bool withFiles = false)
		{
			...
			var result = await _app.Request<List<Model.Note>>("users/notes", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Page>>> Pages(string userId,int limit = 10,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.Page>>("users/pages", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.Flash>>> Flashs(string userId,int limit = 10,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.Flash>>("users/flashs", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.NoteReaction>>> Reactions(string userId,int limit = 10,string? sinceId = null,string? untilId = null,int? sinceDate = null,int? untilDate = null)
		{
			...
			var result = await _app.Request<List<Model.NoteReaction>>("users/reactions", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.UserDetailed>>> Recommendation(int limit = 10,int offset = 0)
		{
			...
			var result = await _app.Request<List<Model.UserDetailed>>("users/recommendation", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		...
		public async Task<Response<RelationResponse>> Relation(JsonNode userId)
		{
			...
			var result = await _app.Request<RelationResponse>("users/relation", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		...
		public async Task<Response<List<Model.User>>> SearchByUsernameAndHost(int limit = 10,bool detail = true,string? username = null,string? host = null)
		{
			...
			var result = await _app.Request<List<Model.User>>("users/search-by-username-and-host", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.User>>> Search(string query,int offset = 0,int limit = 10,SearchOriginEnum origin = SearchOriginEnum.Combined,bool detail = true)
		{
			...
			var result = await _app.Request<List<Model.User>>("users/search", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<ShowResponse>> Show(string userId,string username,List<string>? userIds = null,string? host = null)
		{
			...
			var result = await _app.Request<ShowResponse>("users/show", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<List<AchievementsItemResponseObject>>> Achievements(string userId)
		{
			...
			var result = await _app.Request<List<AchievementsItemResponseObject>>("users/achievements", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
...
namespace Misharp.Controls.Users {
	public class GalleryApi
	{
		...
		public async Task<Response<List<Model.GalleryPost>>> Posts(string userId,int limit = 10,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.GalleryPost>>("users/gallery/posts", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
	}
	public class ListsApi
	{
		...
		public async Task<Response<Model.UserList>> Create(string name)
		{
			...
			var result = await _app.Request<Model.UserList>("users/lists/create", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		...
		public async Task<Response<List<Model.UserList>>> List(string userId)
		{
			...
			var result = await _app.Request<List<Model.UserList>>("users/lists/list", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<Model.UserList>> Show(string listId,bool forPublic = false)
		{
			...
			var result = await _app.Request<Model.UserList>("users/lists/show", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<Model.UserList>> Update(string listId,string name,bool isPublic)
		{
			...
			var result = await _app.Request<Model.UserList>("users/lists/update", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		public async Task<Response<Model.UserList>> CreateFromPublic(string name,string listId)
		{
			...
			var result = await _app.Request<Model.UserList>("users/lists/create-from-public", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		...
		public async Task<Response<List<UsersListsGetMembershipsItemResponseObject>>> GetMemberships(string listId,bool forPublic = false,int limit = 30,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<UsersListsGetMembershipsItemResponseObject>>("users/lists/get-memberships", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
	}
}