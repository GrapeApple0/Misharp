...
namespace Misharp.Controls {
	public class GalleryApi {
		...
		public async Task<Response<List<Model.GalleryPost>>> Featured(int limit = 10,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.GalleryPost>>("gallery/featured", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.GalleryPost>>> Popular()
		{
			var result = await _app.Request<List<Model.GalleryPost>>("gallery/popular", successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		public async Task<Response<List<Model.GalleryPost>>> Posts(int limit = 10,string? sinceId = null,string? untilId = null)
		{
			...
			var result = await _app.Request<List<Model.GalleryPost>>("gallery/posts", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
	}
}
namespace Misharp.Controls.Gallery {
	public class PostsApi
	{
		...
		public async Task<Response<Model.GalleryPost>> Create(string title,string? description = null,List<string>? fileIds = null,bool isSensitive = false)
		{
			...
			var result = await _app.Request<Model.GalleryPost>("gallery/posts/create", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
		...
		public async Task<Response<Model.GalleryPost>> Show(string postId)
		{
			...
			var result = await _app.Request<Model.GalleryPost>("gallery/posts/show", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: false);
			return result;
		}
		...
		public async Task<Response<Model.GalleryPost>> Update(string postId,string title,string? description = null,List<string>? fileIds = null,bool isSensitive = false)
		{
			...
			var result = await _app.Request<Model.GalleryPost>("gallery/posts/update", param, successStatusCode: System.Net.HttpStatusCode.NoContent, useToken: true);
			return result;
		}
	}
}